...
4. Add Environment Variables:
   ...
   - `RENDER_WORKER_TOKEN`: `a-secret-password-of-your-choice`
...
1. Create or update your local `.env` file:
   ```env
   REMOTE_API_URL=https://your-app-name.onrender.com
   RENDER_WORKER_TOKEN=the-same-secret-password-you-set-on-render
